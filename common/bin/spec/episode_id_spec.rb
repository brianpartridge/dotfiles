...
describe 'EpisodeID' do
  ...
  def p1
    EpisodeID.new('1', '1', true)
  end

  def p2
    EpisodeID.new('1', '2', true)
  end
  ...
  describe 'initialize' do
    it 'stores attributes' do
      ...
      expect(p2.season).to eq(1)
      expect(p2.episode).to eq(2)
    end
  ...
  describe 'from_s' do
    it 'parses' do
      ...
      expect(EpisodeID.from_s('Part02')).to eq(p2)
  ...
  describe 'from_release' do
    it 'parses' do
      ...
      expect(EpisodeID.from_release('Series.Part02.123')).to eq(p2)
